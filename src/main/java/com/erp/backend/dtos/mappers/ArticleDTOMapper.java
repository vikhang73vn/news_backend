...
@Autowired
    ...
    public ArticleDto apply(Article article) {
        ...
        return new ArticleDto(article.getId(),article.getTitle(),article.getContent(),categoryDto,authorDto,article.getUrl(),publicationDto,article.getComments(),listSearchKeywordDto, listRelatedArticleDtos,userDto);
    }
}
